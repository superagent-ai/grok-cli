...
export const VERIFY_PROMPT = [
  ...
  "- The prompt should ask it to read config files, package manifests, scripts, and source layout, then return ONLY a JSON VerifyRecipe object with fields: ecosystem, appKind, appLabel, shellInitCommands, bootstrapCommands, installCommands, buildCommands, testCommands, startCommand, startPort, smokeKind, smokeTarget, evidence, notes.",
  "",
  ...
  "- The verify agent should: install deps, build, test, start the app, run browser smoke tests with agent-browser, capture screenshots and video, and produce a structured report.",
  "",
  "Important:",
